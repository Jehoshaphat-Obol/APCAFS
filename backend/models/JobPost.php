...
class JobPost extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            'id' => Yii::t('app', 'ID'),
            'post_company_id' => Yii::t('app', 'Post Company Name'),
            'post_user_id' => Yii::t('app', 'Post User Name'),
            'post_job_title' => Yii::t('app', 'Post Job Title'),
            'post_job_type' => Yii::t('app', 'Post Job Type'),
            'post_job_description' => Yii::t('app', 'Post Job Description'),
            'post_publication_date' => Yii::t('app', 'Post Publication Date'),
            'post_deadline' => Yii::t('app', 'Post Deadline'),
            'post_profession' => Yii::t('app', 'Post Profession'),
            'post_location' => Yii::t('app', 'Post Location'),
            'post_is_remote' => Yii::t('app', 'Post Is Remote'),
            'post_salary_range_min' => Yii::t('app', 'Post Salary Range Min'),
            'post_salary_range_max' => Yii::t('app', 'Post Salary Range Max'),
            'post_status_id' => Yii::t('app', 'Post Status Name'),
            'post_created_at' => Yii::t('app', 'Post Created At'),
            'post_created_by' => Yii::t('app', 'Post Created By'),
            'post_updated_at' => Yii::t('app', 'Post Updated At'),
            'post_updated_by' => Yii::t('app', 'Post Updated By'),
            'post_deleted_at' => Yii::t('app', 'Post Deleted At'),
            'post_deleted_by' => Yii::t('app', 'Post Deleted By'),
        ];
    }
